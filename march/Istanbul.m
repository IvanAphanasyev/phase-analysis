...
tableLowCheb1 = [-1.47768281575585,-1.78746524288204,-1.99602989766829,-2.15511958316750,-2.28340574022564,-2.39011044757310,-2.48060124311884,-2.55834386597657,-2.62574372794051,-2.68456158087819,-2.73613972521969,-2.78153440733819,-2.82159786547985,-2.85703159125442,-2.88842228001633,-2.91626692650236,-2.94099087073675,-2.96296112477631,-2.98249645500303,-2.99987517946343,-3.01534131983171,-3.02910954355383,-3.04136919859840,-3.05228765461243,-3.06201310422947,-3.07067693694256,-3.07839576908503,-3.08527319302317,-3.09140129399947,-3.09686197240512,-3.10172810140674,-3.10606454398652,-3.10992904901306,-3.11337304254628,-3.11644232791878,-3.11917770603031,-3.12161552560283,-3.12378817176942,-3.12572450023754,-3.12745022332343,-3.12898825335907,-3.13035900829618,-3.13158068375225,-3.13266949524272,-3.13363989390823,-3.13450475866704,-3.13527556738970,-3.13596254940114,-3.13657482135751,-3.13712050831780,-3.13760685162851,-3.13804030506166,-3.13842662048747,-3.13877092422316,-3.13907778507361,-3.13935127496916,-3.13959502300645,-3.13981226361056,-3.14000587945831,-3.14017843973279,-3.14033223421703,-3.14046930367960,-3.14059146695555,-3.14070034508194,-3.14079738280863,-3.14088386776962,-3.14096094756942,-3.14102964501132,-3.14109087166946,-3.14114543998498,-3.14119407404667,-3.14123741919926,-3.14127605060684,-3.14131048088482,-3.14134116690220,-3.14136851584385,-3.14139289061367,-3.14141461465007,-3.14143397621785,-3.14145123223326,-3.14146661167317,-3.14148031861339,-3.14149253493672,-3.14150342274633,-3.14151312651686,-3.14152177501145,-3.14152948299036,-3.14153635273379,-3.14154247539906,-3.14154793223023,-3.14155279563613,-3.14155713015120,-3.14156099329182,-3.14156443631953,-3.14156750492120,-3.14157023981531,-3.14157267729226,-3.14157484969588,-3.14157678585264,-3.14157851145416];
points = 1000;
%% PICTURE 1
f = 0.6;
...
plot(w/pi,F2);
line([f f],[0 -pi],'Color','black');
line([0 1],[tableLowCheb1(rp) tableLowCheb1(rp)],'Color','red');
grid on;
%
%% picture 3
f = 0.6;
...
%% picture 4
 ...
 figure('Units', 'normalized', 'OuterPosition', [0 0 1 1]);
plot(tableLowCheb1)
line([0 length(tableLowCheb1)],[-pi -pi],'Color','red');
grid on;
...
range = 19;
 ...
 figure('Units', 'normalized', 'OuterPosition', [0 0 1 1]);
  plot(log_fnc);
  hold on;
  plot(tableLowCheb1(1:range))
  grid on;
  title('y=-0.537 ln(RP)-1.4355')%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  legend({'y=-0.537 ln(RP)-1.4355','table'},'FontSize',12)%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%% picture 5
th =-pi* tanh(0.0792*(1:length(tableLowCheb1)) + 0.4521);
figure('Units', 'normalized', 'OuterPosition', [0 0 1 1]);
 plot(th);
  hold on;
  plot(tableLowCheb1)
