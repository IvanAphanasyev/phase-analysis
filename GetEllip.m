function [AMPL,PH,PH2] = GetEllip(Fc,PD,FLAG)
global points;

if FLAG == "bandpass" || FLAG == "stop"
    [alb,blb] = ellip(1,PD(1), PD(2),[Fc(1) Fc(2)],FLAG);
elseif FLAG == "low" || FLAG == "high"
    [alb,blb] = ellip(2,PD(1), PD(2),Fc(1),FLAG);
else
    error("Invalid string input flag in GetCh1(low, high, bandpass, stop)");
end
